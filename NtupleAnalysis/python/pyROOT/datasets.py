...
class DatasetClass(object):
    ...
    def _MiniAODv2(self):
        '''
        MC Production: RunII, Spring15, MiniAODv2
        CMSSW        : CMSSW_7_4_14
        TWiki Link   : https://twiki.cern.ch/twiki/bin/view/CMSPublic/WorkBookMiniAOD#Run2_Spring15MiniAODv2_re_miniAO
        HN Link      : N/A
        '''
        self.Verbose()
        
        self._SetDefaults("ttHJetToNonbb_M125" ,"7_4_14", PileUp = 140, Events = 8025223, Geometry="Default", TaskDir="RunIISpring15MiniAODv2_ttHJetToNonbb_M125_13TeV_MINIAODSIM", TaskSubDir = "/res/")
