...
import UCYHiggsAnalysis.NtupleAnalysis.tools.tdrstyle as tdrstyle
import UCYHiggsAnalysis.NtupleAnalysis.tools.styles as styles
import UCYHiggsAnalysis.NtupleAnalysis.tools.plots as plots
import UCYHiggsAnalysis.NtupleAnalysis.tools.histograms as histograms
...
def main():
    ...
    # Find module names
    myNames = findModuleNames(opts.mcrab, "Test")
