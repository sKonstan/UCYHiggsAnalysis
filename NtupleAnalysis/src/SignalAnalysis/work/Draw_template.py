...
#================================================================================================
NumJets={
    "xLabel": "Numb Jets"           , "xUnits": "", "xMin": 0.00 , "xMax": 30, "binWidthX": None, "xCutLines": [], "xCutBoxes": [], "gridX": True, "logX": False,
...
NumLep={
    "xLabel": "Numb Lep"           , "xUnits": "", "xMin": 0.00 , "xMax": 30, "binWidthX": None, "xCutLines": [], "xCutBoxes": [], "gridX": True, "logX": False,
    "yLabel": "Entries / %0.0f" , "yUnits": ""         , "yMin": 1E-01, "yMax": None , "binWidthY": None, "yCutLines": [], "yCutBoxes": [], "gridY": True, "logY": True,
    "ratioLabel": "Ratio", "yMinRatio": 0.0 , "yMaxRatio": 2.15 ,
    "logYRatio": False, "logXRatio": False, "xLegMin": 0.70, "xLegMax": 0.95, "yLegMin": 0.78, "yLegMax": 0.93, "gridXRatio": True, "gridYRatio": True,
}
...
hPassedMLepNJets_op = histos.DrawObject( folder,"PassedMLepNGJets_op","passed",**NumJets )
hPassedMLepNJets_same = histos.DrawObject( folder,"PassedMLepNGJets_same","passed",**NumJets )
hAllMLepNJets_op = histos.DrawObject( folder,"AllMLepNGJets_op","all",**NumJets)
hAllMLepNJets_same = histos.DrawObject( folder,"AllMLepNGJets_same","all",**NumJets)
hAllMET=histos.DrawObject( folder, "AllMET" , "all", **Pt )
...
def main():
    ...
    ### Define Lists
    #xxx
    histoList = [hAllMLepPt_op, hAllMLepJPt_op, hPassedMLepNJets_op, hAllMLepNJets_op, hAllMLepEta_op, hAllMLepJEta_op,  hAllMLepleadLepPt_op, hAllMLepsubleadLepPt_op, hAllMLepNLep_op]
    #histoList = [hAllMLepPt_same, hAllMLepJPt_same, hPassedMLepNJets_same, hAllMLepNJets_same, hAllMLepEta_same, hAllMLepJEta_same,  hAllMLepleadLepPt_same, hAllMLepsubleadLepPt_same, hAllMLepNLep_same]
