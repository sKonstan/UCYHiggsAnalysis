...
public:
  ...
  std::vector<std::string> getIsolationDiscriminatorNames() const {
    static std::vector<std::string> n = { std::string("byCombinedIsolationDeltaBetaCorrRaw3Hits"), std::string("byIsolationMVA3newDMwLTraw"), std::string("byIsolationMVA3oldDMwLTraw"), std::string("byLooseCombinedIsolationDeltaBetaCorr3Hits"), std::string("byLooseIsolationMVA3newDMwLT"), std::string("byLooseIsolationMVA3oldDMwLT"), std::string("byLoosePileupWeightedIsolation3Hits"), std::string("byMediumCombinedIsolationDeltaBetaCorr3Hits"), std::string("byMediumIsolationMVA3newDMwLT"), std::string("byMediumIsolationMVA3oldDMwLT"), std::string("byMediumPileupWeightedIsolation3Hits"), std::string("byPileupWeightedIsolationRaw3Hits"), std::string("byTightCombinedIsolationDeltaBetaCorr3Hits"), std::string("byTightIsolationMVA3newDMwLT"), std::string("byTightIsolationMVA3oldDMwLT"), std::string("byTightPileupWeightedIsolation3Hits"), std::string("byVLooseIsolationMVA3newDMwLT"), std::string("byVLooseIsolationMVA3oldDMwLT"), std::string("byVTightIsolationMVA3newDMwLT"), std::string("byVTightIsolationMVA3oldDMwLT"), std::string("byVVTightIsolationMVA3newDMwLT"), std::string("byVVTightIsolationMVA3oldDMwLT")};
    return n;
  }
  ...
  std::vector<std::string> getAgainstElectronDiscriminatorNames() const {
    static std::vector<std::string> n = { std::string("againstElectronLooseMVA5"), std::string("againstElectronMVA5category"), std::string("againstElectronMVA5raw"), std::string("againstElectronMediumMVA5"), std::string("againstElectronTightMVA5"), std::string("againstElectronVLooseMVA5"), std::string("againstElectronVTightMVA5")};
    return n;
  }
...
public:
  ...
  std::vector<std::function<bool()>> getIsolationDiscriminatorValues() const {
    static std::vector<std::function<bool()>> values = {
      ...
      [&](){ return this->byLoosePileupWeightedIsolation3Hits(); },
      ...
      [&](){ return this->byMediumPileupWeightedIsolation3Hits(); },
      [&](){ return this->byPileupWeightedIsolationRaw3Hits(); },
      ...
      [&](){ return this->byTightPileupWeightedIsolation3Hits(); },
