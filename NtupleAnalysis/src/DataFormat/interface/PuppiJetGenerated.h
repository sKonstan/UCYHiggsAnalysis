...
#ifndef DataFormat_PuppiJetGenerated_h
#define DataFormat_PuppiJetGenerated_h
...
class PuppiJetGeneratedCollection: public ParticleCollection<double> {
public:
  explicit PuppiJetGeneratedCollection(const std::string& prefix="PuppiJets")
  : ParticleCollection(prefix),
    fMCjet(prefix)
  {
    fMCjet.setEnergySystematicsVariation("_MCjet");
  }
  ~PuppiJetGeneratedCollection() {}
...
class PuppiJetGenerated: public Particle<Coll> {
public:
  PuppiJetGenerated() {}
  PuppiJetGenerated(const Coll* coll, size_t index)
