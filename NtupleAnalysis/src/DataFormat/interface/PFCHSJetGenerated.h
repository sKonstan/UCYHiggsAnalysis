...
#ifndef DataFormat_PFCHSJetGenerated_h
#define DataFormat_PFCHSJetGenerated_h
...
class PFCHSJetGeneratedCollection: public ParticleCollection<double> {
public:
  explicit PFCHSJetGeneratedCollection(const std::string& prefix="PFCHSJets")
  : ParticleCollection(prefix),
    fMCjet(prefix)
  {
    fMCjet.setEnergySystematicsVariation("_MCjet");
  }
  ~PFCHSJetGeneratedCollection() {}
...
class PFCHSJetGenerated: public Particle<Coll> {
public:
  PFCHSJetGenerated() {}
  PFCHSJetGenerated(const Coll* coll, size_t index)
