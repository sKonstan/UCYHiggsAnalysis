...
class L1PixelTrackFit{     
 public:
  ...
  L1PixelTrackFit(double Bz=3.8112);
 ...
 std::vector<TVector3> pixHitL1;
 std::vector<TVector3> pixHitL2;
 std::vector<TVector3> pixHitL3;
 std::vector<TVector3> pixHitL4;
 std::vector<TVector3> pixHitD1;
 std::vector<TVector3> pixHitD2;
 std::vector<TVector3> pixHitD3;
 double rinvfit;
 double phi0fit;
 double d0fit;
 double tfit;
