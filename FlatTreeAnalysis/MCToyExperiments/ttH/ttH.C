...
void ttH()
{
  ...
  // Double_t Sigma = 508.5;//in fb
  // Double_t Lumi = 100;   //in fb-1
  // Double_t Factor = Sigma * Lumi;

  ofstream myfile;
  myfile.open ("MCToyFinal.txt");//, ios::app);
  myfile<<"\n\n\n";
  ...
  myfile<<"\n                           HWW                         \n";
  myfile<<" _____________________________________________________________\n";
  myfile<<"Final State \t \t  B.R.  \t \t Events@100 fb-1 ";
  myfile<<"\n _____________________________________________________________\n";
  myfile<< setprecision(4);
  myfile<< fixed;
  myfile<< "0l 0Th \t \t \t    "<<setprecision(4)<<HWWn0l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn0l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 1Th \t \t \t    "<<setprecision(4)<<HWWn0l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn0l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 2Th \t \t \t    "<<setprecision(4)<<HWWn0l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn0l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 3Th \t \t \t    "<<setprecision(4)<<HWWn0l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn0l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 4Th \t \t \t    "<<setprecision(4)<<HWWn0l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn0l4Th/TotalExp*nEvtLumi<<endl;


  myfile<< "1l 0Th \t \t \t    "<<setprecision(4)<< HWWn1l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn1l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 1Th \t \t \t    "<<setprecision(4)<< HWWn1l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn1l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 2Th \t \t \t    "<<setprecision(4)<< HWWn1l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn1l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 3Th \t \t \t    "<<setprecision(4)<< HWWn1l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn1l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 4Th \t \t \t    "<<setprecision(4)<< HWWn1l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn1l4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "2l 0Th \t \t \t    "<<setprecision(4)<< HWWn2l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 1Th \t \t \t    "<<setprecision(4)<< HWWn2l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 2Th \t \t \t    "<<setprecision(4)<< HWWn2l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 3Th \t \t \t    "<<setprecision(4)<< HWWn2l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 4Th \t \t \t    "<<setprecision(4)<< HWWn2l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2l4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "2lss 0Th \t \t    "<<setprecision(4)<<HWWn2lss0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2lss0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 1Th \t \t    "<<setprecision(4)<<HWWn2lss1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2lss1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 2Th \t \t    "<<setprecision(4)<<HWWn2lss2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2lss2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 3Th \t \t    "<<setprecision(4)<<HWWn2lss3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2lss3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 4Th \t \t    "<<setprecision(4)<<HWWn2lss4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2lss4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "2los 0Th \t \t    "<<setprecision(4)<<HWWn2los0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2los0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 1Th \t \t    "<<setprecision(4)<<HWWn2los1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2los1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 2Th \t \t    "<<setprecision(4)<<HWWn2los2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2los2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 3Th \t \t    "<<setprecision(4)<<HWWn2los3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2los3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 4Th \t \t    "<<setprecision(4)<<HWWn2los4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn2los4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "3l 0Th \t \t \t    "<<setprecision(4)<< HWWn3l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn3l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 1Th \t \t \t    "<<setprecision(4)<< HWWn3l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn3l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 2Th \t \t \t    "<<setprecision(4)<< HWWn3l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn3l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 3Th \t \t \t    "<<setprecision(4)<< HWWn3l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn3l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 4Th \t \t \t    "<<setprecision(4)<< HWWn3l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn3l4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "4l 0Th \t \t \t    "<<setprecision(4)<< HWWn4l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn4l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 1Th \t \t \t    "<<setprecision(4)<< HWWn4l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn4l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 2Th \t \t \t    "<<setprecision(4)<< HWWn4l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn4l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 3Th \t \t \t    "<<setprecision(4)<< HWWn4l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn4l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 4Th \t \t \t    "<<setprecision(4)<< HWWn4l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HWWn4l4Th/TotalExp*nEvtLumi<<endl;
  ...
  myfile<< "0l 0Th \t \t \t    "<<setprecision(4)<< HTTn0l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn0l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 1Th \t \t \t    "<<setprecision(4)<< HTTn0l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn0l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 2Th \t \t \t    "<<setprecision(4)<< HTTn0l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn0l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 3Th \t \t \t    "<<setprecision(4)<< HTTn0l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn0l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 4Th \t \t \t    "<<setprecision(4)<< HTTn0l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn0l4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "1l 0Th \t \t \t    "<<setprecision(4)<< HTTn1l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn1l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 1Th \t \t \t    "<<setprecision(4)<< HTTn1l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn1l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 2Th \t \t \t    "<<setprecision(4)<< HTTn1l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn1l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 3Th \t \t \t    "<<setprecision(4)<< HTTn1l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn1l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 4Th \t \t \t    "<<setprecision(4)<< HTTn1l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn1l4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "2l 0Th \t \t \t    "<<setprecision(4)<< HTTn2l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 1Th \t \t \t    "<<setprecision(4)<< HTTn2l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 2Th \t \t \t    "<<setprecision(4)<< HTTn2l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 3Th \t \t \t    "<<setprecision(4)<< HTTn2l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 4Th \t \t \t    "<<setprecision(4)<< HTTn2l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2l4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "2lss 0Th \t \t    "<<setprecision(4)<<HTTn2lss0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2lss0Th/TotalExp*nEvtLumi<<endl;  
  myfile<< "2lss 1Th \t \t    "<<setprecision(4)<<HTTn2lss1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2lss1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 2Th \t \t    "<<setprecision(4)<<HTTn2lss2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2lss2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 3Th \t \t    "<<setprecision(4)<<HTTn2lss3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2lss3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 4Th \t \t    "<<setprecision(4)<<HTTn2lss4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2lss4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "2los 0Th \t \t    "<<setprecision(4)<<HTTn2los0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2los0Th/TotalExp*nEvtLumi<<endl;  
  myfile<< "2los 1Th \t \t    "<<setprecision(4)<<HTTn2los1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2los1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 2Th \t \t    "<<setprecision(4)<<HTTn2los2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2los2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 3Th \t \t    "<<setprecision(4)<<HTTn2los3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2los3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 4Th \t \t    "<<setprecision(4)<<HTTn2los4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn2los4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "3l 0Th \t \t \t    "<<setprecision(4)<< HTTn3l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn3l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 1Th \t \t \t    "<<setprecision(4)<< HTTn3l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn3l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 2Th \t \t \t    "<<setprecision(4)<< HTTn3l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn3l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 3Th \t \t \t    "<<setprecision(4)<< HTTn3l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn3l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 4Th \t \t \t    "<<setprecision(4)<< HTTn3l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn3l4Th/TotalExp*nEvtLumi<<endl;

  myfile<< "4l 0Th \t \t \t    "<<setprecision(4)<< HTTn4l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn4l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 1Th \t \t \t    "<<setprecision(4)<< HTTn4l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn4l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 2Th \t \t \t    "<<setprecision(4)<< HTTn4l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn4l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 3Th \t \t \t    "<<setprecision(4)<< HTTn4l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn4l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 4Th \t \t \t    "<<setprecision(4)<< HTTn4l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HTTn4l4Th/TotalExp*nEvtLumi<<endl;
  ...
  myfile<< "0l 0Th \t \t \t    "<<setprecision(4)<< HZZn0l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn0l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 1Th \t \t \t    "<<setprecision(4)<< HZZn0l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn0l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 2Th \t \t \t    "<<setprecision(4)<< HZZn0l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn0l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 3Th \t \t \t    "<<setprecision(4)<< HZZn0l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn0l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 4Th \t \t \t    "<<setprecision(4)<< HZZn0l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn0l4Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 5Th \t \t \t    "<<setprecision(4)<< HZZn0l5Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn0l5Th/TotalExp*nEvtLumi<<endl;
  myfile<< "0l 6Th \t \t \t    "<<setprecision(4)<< HZZn0l6Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn0l6Th/TotalExp*nEvtLumi<<endl;

  myfile<< "1l 0Th \t \t \t    "<<setprecision(4)<< HZZn1l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn1l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 1Th \t \t \t    "<<setprecision(4)<< HZZn1l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn1l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 2Th \t \t \t    "<<setprecision(4)<< HZZn1l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn1l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 3Th \t \t \t    "<<setprecision(4)<< HZZn1l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn1l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 4Th \t \t \t    "<<setprecision(4)<< HZZn1l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn1l4Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 5Th \t \t \t    "<<setprecision(4)<< HZZn1l5Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn1l5Th/TotalExp*nEvtLumi<<endl;
  myfile<< "1l 6Th \t \t \t    "<<setprecision(4)<< HZZn1l6Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn1l6Th/TotalExp*nEvtLumi<<endl;

  myfile<< "2l 0Th \t \t \t    "<<setprecision(4)<< HZZn2l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 1Th \t \t \t    "<<setprecision(4)<< HZZn2l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 2Th \t \t \t    "<<setprecision(4)<< HZZn2l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 3Th \t \t \t    "<<setprecision(4)<< HZZn2l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 4Th \t \t \t    "<<setprecision(4)<< HZZn2l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2l4Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 5Th \t \t \t    "<<setprecision(4)<< HZZn2l5Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2l5Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2l 6Th \t \t \t    "<<setprecision(4)<< HZZn2l6Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2l6Th/TotalExp*nEvtLumi<<endl;


  myfile<< "2lss 0Th \t \t    "<<setprecision(4)<<HZZn2lss0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2lss0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 1Th \t \t    "<<setprecision(4)<<HZZn2lss1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2lss1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 2Th \t \t    "<<setprecision(4)<<HZZn2lss2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2lss2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 3Th \t \t    "<<setprecision(4)<<HZZn2lss3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2lss3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 4Th \t \t    "<<setprecision(4)<<HZZn2lss4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2lss4Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 5Th \t \t    "<<setprecision(4)<<HZZn2lss5Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2lss5Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2lss 6Th \t \t    "<<setprecision(4)<<HZZn2lss6Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2lss6Th/TotalExp*nEvtLumi<<endl;

  myfile<< "2los 0Th \t \t    "<<setprecision(4)<<HZZn2los0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2los0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 1Th \t \t    "<<setprecision(4)<<HZZn2los1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2los1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 2Th \t \t    "<<setprecision(4)<<HZZn2los2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2los2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 3Th \t \t    "<<setprecision(4)<<HZZn2los3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2los3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 4Th \t \t    "<<setprecision(4)<<HZZn2los4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2los4Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 5Th \t \t    "<<setprecision(4)<<HZZn2los5Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2los5Th/TotalExp*nEvtLumi<<endl;
  myfile<< "2los 6Th \t \t    "<<setprecision(4)<<HZZn2los6Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn2los6Th/TotalExp*nEvtLumi<<endl;

  myfile<< "3l 0Th \t \t \t    "<<setprecision(4)<< HZZn3l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn3l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 1Th \t \t \t    "<<setprecision(4)<< HZZn3l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn3l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 2Th \t \t \t    "<<setprecision(4)<< HZZn3l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn3l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 3Th \t \t \t    "<<setprecision(4)<< HZZn3l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn3l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 4Th \t \t \t    "<<setprecision(4)<< HZZn3l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn3l4Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 5Th \t \t \t    "<<setprecision(4)<< HZZn3l5Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn3l5Th/TotalExp*nEvtLumi<<endl;
  myfile<< "3l 6Th \t \t \t    "<<setprecision(4)<< HZZn3l6Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn3l6Th/TotalExp*nEvtLumi<<endl;

  myfile<< "4l 0Th \t \t \t    "<<setprecision(4)<< HZZn4l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn4l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 1Th \t \t \t    "<<setprecision(4)<< HZZn4l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn4l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 2Th \t \t \t    "<<setprecision(4)<< HZZn4l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn4l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 3Th \t \t \t    "<<setprecision(4)<< HZZn4l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn4l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 4Th \t \t \t    "<<setprecision(4)<< HZZn4l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn4l4Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 5Th \t \t \t    "<<setprecision(4)<< HZZn4l5Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn4l5Th/TotalExp*nEvtLumi<<endl;
  myfile<< "4l 6Th \t \t \t    "<<setprecision(4)<< HZZn4l6Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn4l6Th/TotalExp*nEvtLumi<<endl;

  myfile<< "5l 0Th \t \t \t    "<<setprecision(4)<< HZZn5l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn5l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "5l 1Th \t \t \t    "<<setprecision(4)<< HZZn5l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn5l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "5l 2Th \t \t \t    "<<setprecision(4)<< HZZn5l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn5l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "5l 3Th \t \t \t    "<<setprecision(4)<< HZZn5l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn5l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "5l 4Th \t \t \t    "<<setprecision(4)<< HZZn5l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn5l4Th/TotalExp*nEvtLumi<<endl;
  myfile<< "5l 5Th \t \t \t    "<<setprecision(4)<< HZZn5l5Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn5l5Th/TotalExp*nEvtLumi<<endl;
  myfile<< "5l 6Th \t \t \t    "<<setprecision(4)<< HZZn5l6Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn5l6Th/TotalExp*nEvtLumi<<endl;

  myfile<< "6l 0Th \t \t \t    "<<setprecision(4)<< HZZn6l0Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn6l0Th/TotalExp*nEvtLumi<<endl;
  myfile<< "6l 1Th \t \t \t    "<<setprecision(4)<< HZZn6l1Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn6l1Th/TotalExp*nEvtLumi<<endl;
  myfile<< "6l 2Th \t \t \t    "<<setprecision(4)<< HZZn6l2Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn6l2Th/TotalExp*nEvtLumi<<endl;
  myfile<< "6l 3Th \t \t \t    "<<setprecision(4)<< HZZn6l3Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn6l3Th/TotalExp*nEvtLumi<<endl;
  myfile<< "6l 4Th \t \t \t    "<<setprecision(4)<< HZZn6l4Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn6l4Th/TotalExp*nEvtLumi<<endl;
  myfile<< "6l 5Th \t \t \t    "<<setprecision(4)<< HZZn6l5Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn6l5Th/TotalExp*nEvtLumi<<endl;
  myfile<< "6l 6Th \t \t \t    "<<setprecision(4)<< HZZn6l6Th/TotalExp<<" \t \t \t "<<setprecision(1)<<HZZn6l6Th/TotalExp*nEvtLumi<<endl;
