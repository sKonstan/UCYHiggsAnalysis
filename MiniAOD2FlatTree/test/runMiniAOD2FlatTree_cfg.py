...
iMaxEvents       = 1000
iReportEvery     = 10
skimType         = "TriggerSkim" #"TriggerSkim" #"NoSkim #"DefaultSkim"
            ...
            "Flag_eeBadScFilter",
                            ...
                            Tracks = cms.VPSet(
                                cms.PSet(
                                    ...
                                    OfflinePrimaryVertexSrc  = cms.InputTag("offlineSlimmedPrimaryVertices"),
                                    ptCut                    = cms.untracked.double(5.0), # pt < value [GeV/c]
